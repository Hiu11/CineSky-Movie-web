...
const HomePage = ({ searchQuery = "" }) => {
  ...
  const soonMovies = [
    ...
    },
    {
      ...
      rating: "K",
      ratingClass: "p-rating",
      ratingDesc: "**K:** Phim dành cho khán giả dưới 13 tuổi khi xem cùng cha mẹ hoặc người giám hộ",
      times: ["Chưa có lịch"],
    },
    {
      id: 103,
  ...
  const filteredMovies =
    normalizedQuery.length === 0 ? activeMovies : activeMovies.filter((movie) => normalizeText(movie.title).includes(normalizedQuery));
